...
export default function CompetitionResult() {
    ...
    return (
        <div className="w-full min-h-screen overflow-x-auto flex justify-start pb-6 px-6">
                    ...
                    sport == "ฟุตซอล" ? <div className="flex flex-col justify-center gap-8"><div className="text-xl font-bold text-white">ทีมทั้งหมด <Chip label={`${team} ทีม`} size="small" sx={{
                        ...
                        : sport == "บาสเกตบอลชาย" ? <div className="flex flex-col justify-center gap-8"><div className="text-xl font-bold text-white">ทีมทั้งหมด <Chip label={`${team} ทีม`} size="small" sx={{
                            ...
                            : sport == "บาสเกตบอลหญิง" ? <div className="flex flex-col justify-center gap-8"><div className="text-xl font-bold text-white">ทีมทั้งหมด <Chip label={`${team} ทีม`} size="small" sx={{
                                ...
                                : sport == "แข่งเกม prompt" ? <div className="flex flex-col justify-center gap-8"><div className="text-xl font-bold text-white">ทีมทั้งหมด <Chip label={`${team} ทีม`} size="small" sx={{
                                ...
                                }}></Chip></div><div className="flex w-full justify-center items-center"><PromptResultTableFinal /></div></div>
                                    ...
                                    }}></Chip></div><div className="flex w-full justify-center items-center"><QuizResultTableFinal /></div></div>
